...
export const validate = (validator: Validator | null, value: JsonType, errorMessage: string) => {
  if (validator) {
...
export const createParamsSchema = (operationSchema: OpenApiOperationSchema, apiSchema: OpenApiSchema) => {
...
export const createResultSchema = (operationSchema: OpenApiOperationSchema, schema: OpenApiSchema) => {
